...
>(
  (
    ...
    const { isMobile, state, openMobile, setOpenMobile, isHidden } =
      useSidebar();
            ...
            >
              <VisuallyHidden asChild>
                <SheetHeader>
                  ...
                  <SheetDescription>
                    Access navigation menu for mobile devices.
                  </SheetDescription>
                </SheetHeader>
              </VisuallyHidden>
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden text-sidebar-foreground md:block animate-in fade-in-0 duration-200"
        data-state={state}
